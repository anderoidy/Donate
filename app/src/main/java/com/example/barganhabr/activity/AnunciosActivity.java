...
import com.example.barganhabr.adapter.AdapterAnuncios;
import com.example.barganhabr.helper.ConfiguracaoFirebase;
import com.example.barganhabr.helper.RecyclerItemClickListener;
...
public class AnunciosActivity extends AppCompatActivity {
    ...
    private boolean filtrarPorEstado = false;
    ...
    public void filtrarPorCategoria (View view){
        ...
        if ( filtrarPorEstado == true ){

            AlertDialog.Builder dialogEstado = new AlertDialog.Builder(this);
            dialogEstado.setTitle("Selecione o categoria desejado");
            ...
            Toast.makeText(this, "Escolha primeiro uma regiao!",
